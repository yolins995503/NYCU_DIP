...
def main():
    ...
    parser.add_argument("-input", help="path to the input image" , default='/home/bsplab/Documents/yolin/DIP_HW3/jpeg-python-0/1196501.jpg')
    parser.add_argument("-output", help="path to the output image" , default='/home/bsplab/Documents/yolin/DIP_HW3/jpeg-python-0/1196501_encoder.jpeg')
    ...
    # block size: 8x8
    if rows % args.block_size == cols % args.block_size == 0:
        blocks_count = rows // args.block_size * cols // args.block_size
    else:
